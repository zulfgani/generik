...
add_action( 'customize_register', function() {
    ...
    class AcidToggle extends WP_Customize_Control {
		...
		<style type="text/css" id="acid-toggle-css">
			...
			li.customize-control-toggle .toggle-flex {display: -webkit-box;display: -moz-box;display: -ms-flexbox;display: -webkit-flex;display: flex;align-items: center;}
			li.customize-control-toggle .toggle-flex .flex-inner-wide {padding-left: 10px;}
		</style>
	<?php
	}
    }
